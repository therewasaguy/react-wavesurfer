...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Wavesurfer, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (this.props.peaks !== nextProps.peaks) {
	        var mediaElt = document.getElementById(this.props.mediaEltId);
	    ...
	    key: '_loadAudio',
	    value: function _loadAudio(audioFileOrElt, peaks) {
	...
	Wavesurfer.propTypes = {
	  ...
	  peaks: _react.PropTypes.array,
	  mediaEltId: _react.PropTypes.string,
